...
@AutoValue
public abstract class SourceIpFinding {
  public abstract Instant getRequestTime();
  public abstract String getSourceIp();
  public abstract Finding getFinding();

  public static SourceIpFinding create(Instant newRequestTime, String newSourceIp,
      Finding newFinding) {
    return builder()
  ...
  public static Builder builder() {
    return new AutoValue_SourceIpFinding.Builder();
  }
  ...
  public abstract static class Builder {
    ...
    public abstract SourceIpFinding build();
  }
}
